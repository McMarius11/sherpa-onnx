...
// Obtain a valid JNIEnv* for the current thread.  If the thread was not created
// by the JVM, it is attached automatically; *did_attach is set to true so the
// caller can detach later.  Returns nullptr on failure.
